...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        metavar='S_0',
        type=int,
        default=160000000) # Asymptotes the amount of susceptible indivuals at this number
...
class Learner(object):
    ...
    def load_confirmed(self, country):
        df = pd.read_csv('5-2/time_series_covid19_confirmed.csv')
        country_df = df[df['Country/Region'] == country]
        return country_df.iloc[0].loc[self.start_date:]


    def load_recovered(self, country):
        df = pd.read_csv('5-2/time_series_covid19_recovered.csv')
        country_df = df[df['Country/Region'] == country]
        return country_df.iloc[0].loc[self.start_date:]


    def load_dead(self, country):
        df = pd.read_csv('5-2/time_series_covid19_deaths.csv')
        country_df = df[df['Country/Region'] == country]
        return country_df.iloc[0].loc[self.start_date:]
...
def main():
    ...
    # sumCases_province('5-2/time_series_19-covid-Confirmed.csv', '5-2/time_series_19-covid-Confirmed.csv')
    # sumCases_province('5-2/time_series_19-covid-Recovered.csv', '5-2/time_series_19-covid-Recovered.csv')
    # sumCases_province('5-2/time_series_19-covid-Deaths.csv', '5-2/time_series_19-covid-Deaths.csv')
